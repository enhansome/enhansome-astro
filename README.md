...
* [Build a Recipe collection website with Astro](https://daily-dev-tips.com/posts/astro-recipe-collection-website-part-1-setup-collections) - Parts → [1](https://daily-dev-tips.com/posts/astro-recipe-collection-website-part-1-setup-collections/) - [2](https://daily-dev-tips.com/posts/astro-recipe-collection-website-part-2-homepage-rendering/) - [3](https://daily-dev-tips.com/posts/astro-recipe-collection-website-part-3-category-filter-pages/) - [4](https://daily-dev-tips.com/posts/astro-recipe-collection-website-part-4-styling-the-website/) - [5](https://daily-dev-tips.com/posts/astro-recipe-collection-website-part-5-hosting-on-netlify/)
...
* [Astro Theme - AstroWind](https://github.com/onwidget/astrowind) ⭐ 5,934 | 🐛 1 | 🌐 Astro | 📅 2026-09-05 - Started template to make a website using Astro and Tailwind CSS.
* [Astro Theme - Cactus](https://github.com/chrismwilliams/astro-theme-cactus) ⭐ 1,722 | 🐛 8 | 🌐 Astro | 📅 2026-07-25 - Simple, opinionated starter built with the Astro framework for blog or website
* [Astro Theme - Odessey](https://github.com/littlesticksdev/odyssey-theme) ⭐ 783 | 🐛 15 | 🌐 Astro | 📅 2024-10-16 - A marketing website theme built with Astro and carefully crafted for startups and businesses
* [Starwind UI](https://github.com/starwind-ui/starwind-ui) ⭐ 723 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-05 - A set of powerful, accessible components for your Astro projects. Styled with Tailwind CSS v4.
* [Astro Ink](https://github.com/one-aalam/astro-ink) ⭐ 595 | 🐛 9 | 🌐 Astro | 📅 2025-11-03 - Crisp, minimal, personal blog theme for Astro
* [Tailcast](https://github.com/matt765/Tailcast) ⭐ 402 | 🐛 6 | 🌐 Astro | 📅 2026-04-12 - Dark-themed website template built with Astro and Tailwind CSS. 8 pages, SEO optimization, and view transitions.
* [Astro Theme - Creek](https://github.com/robertguss/Astro-Theme-Creek) ⭐ 286 | 🐛 2 | 🌐 Astro | 📅 2026-08-20 - A Blog theme for Astro
...
* [Astro + Supabase + Vercel](https://github.com/magnuswahlstrand/astro-supabase-vercel) ⭐ 90 | 🐛 3 | 🌐 Astro | 📅 2023-07-03
* [Catonaut](https://github.com/AminoffZ/catonaut) ⭐ 85 | 🐛 1 | 🌐 TypeScript | 📅 2024-10-14 - Browser extension template using Astro and Bun.
* [AstroDeck](https://github.com/holger1411/astrodeck) ⭐ 74 | 🐛 0 | 🌐 Astro | 📅 2026-09-05 - Production-ready Astro 6 starter with Tailwind CSS 4, shadcn/ui, dark mode, 11 page templates and 5 AI agents (AGENTS.md)
...
* [Astro-react-vue-demo](https://github.com/cassidoo/astro-react-vue-demo) ⭐ 52 | 🐛 0 | 🌐 CSS | 📅 2021-06-24
* [Astro Me](https://github.com/one-aalam/astro-me) ⭐ 52 | 🐛 1 | 🌐 Astro | 📅 2021-10-08 - Crisp, minimal, personal portfolio theme for Astro
...
* [Astro Blog Starter with Netlify CMS](https://github.com/delucis/astro-netlify-cms-starter) ⭐ 40 | 🐛 9 | 🌐 Astro | 📅 2023-10-18 - Template based on the Astro blog starter kit + Astro Netlify CMS integration.
* [Astro Static Tweet](https://github.com/rebelchris/astro-static-tweet) ⭐ 38 | 🐛 0 | 🌐 Astro | 📅 2022-02-19
* [Astro TAP Stack](https://github.com/codiume/the-tap-stack) ⭐ 32 | 🐛 0 | 🌐 Astro | 📅 2022-09-04 - Opinionated astro starter kit (Typescript & Tailwind + Astro + Prisma & Planet scale)
...
* [Refo](https://github.com/kireerik/refo) ⭐ 18 | 🐛 4 | 🌐 JavaScript | 📅 2026-03-01 - A static site and resume example with styled components.
...
* [Astro Icon](https://github.com/natemoo-re/astro-icon) ⭐ 1,438 | 🐛 16 | 🌐 MDX | 📅 2026-08-25 - Straight-forward Icon component for Astro
* [Astro SEO](https://github.com/jonasmerlin/astro-seo) ⭐ 1,392 | 🐛 1 | 🌐 Astro | 📅 2026-08-28 - Better SEO with Astro
...
* [Astro Breadcrumbs](https://github.com/felix-berlin/astro-breadcrumbs) ⭐ 218 | 🐛 13 | 🌐 TypeScript | 📅 2026-09-05 - Well configurable breadcrumb component for Astro. Create breadcrumbs completely dynamically or specify exactly how they should look.
* [Astro Collection](https://github.com/JulianCataldo/astro) ⚠️ Archived - An Astro components and configurations collection
* [Astroad](https://github.com/mooxl/astroad) ⭐ 165 | 🐛 19 | 🌐 TypeScript | 📅 2025-01-13 - A pre-configured setup for easy website development with Astro and Payload CMS using Docker.
* [Astro Auto-import](https://github.com/delucis/astro-auto-import) ⭐ 158 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-02 - Auto-import components in Astro projects
...
* [Astro Forms](https://github.com/jackmerrill/AstroForms) ⭐ 29 | 🐛 2 | 🌐 Astro | 📅 2022-07-18 - Forms in Astro made easy
* [Astro Pandoc](https://github.com/trashhalo/astro-pandoc) ⭐ 22 | 🐛 0 | 🌐 Astro | 📅 2021-09-19 - Pandoc rendering for Astro
* [Astro Gist](https://github.com/kotosha-real/astro-gist) ⭐ 16 | 🐛 0 | 🌐 Astro | 📅 2025-12-22 - Astro component to easily add GitHub gists to your blog
* [Sarissa Pagination](https://github.com/iozcelik/SarissaPagination) ⭐ 12 | 🐛 0 | 🌐 Astro | 📅 2022-06-11 - Add page number buttons for pagination. Automatically add and disable numbers as current page number.
* [astro-loader-goodreads](https://github.com/sadmanca/astro-loader-goodreads) ⭐ 8 | 🐛 2 | 🌐 TypeScript | 📅 2026-03-13 - Load Goodreads data for books in shelves/lists, user updates, and author blogs into Astro.
...
* [@unocss/astro](https://github.com/unocss/unocss/tree/main/packages/astro) ⭐ 18,946 | 🐛 138 | 🌐 TypeScript | 📅 2026-09-06 - The UnoCSS integration for Astro
* [Frontman](https://github.com/frontman-ai/frontman) ⭐ 689 | 🐛 226 | 🌐 ReScript | 📅 2026-09-05 - An open-source AI coding agent that lives in your browser, letting you click any element and describe changes in plain English to get real code edits with hot reload.
...
* [@yeskunall/umami](https://github.com/yeskunall/astro-umami) ⭐ 72 | 🐛 13 | 🌐 TypeScript | 📅 2026-08-31 - Add Umami Analytics to your website
...
* [Astro Snapshot](https://github.com/twocaretcat/astro-snapshot) ⭐ 14 | 🐛 7 | 🌐 TypeScript | 📅 2026-08-30 - An Astro integration for generating screenshots of your pages automatically at build time
* [@aeorank/astro](https://github.com/vinpatel/aeorank) ⭐ 14 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-05 - AEO (Answer Engine Optimization) integration for Astro — generates llms.txt, schema.json, and more AI-readable files
...
* [Taiwan.md](https://taiwan.md) - Open-source, AI-friendly knowledge base about Taiwan. 400+ Markdown articles, bilingual, knowledge graph, and public API. ([GitHub](https://github.com/frank890417/taiwan-md) ⭐ 1,167 | 🐛 4 | 🌐 HTML | 📅 2026-09-06 — 600+ ⭐)
* [Watchboard](https://artemiop.com/watchboard/) - AI-powered intelligence dashboard platform with 48 trackers, CesiumJS 3D globe, Leaflet maps, and nightly automated data updates ([Source](https://github.com/ArtemioPadilla/watchboard) ⭐ 19 | 🐛 15 | 🌐 TypeScript | 📅 2026-09-06)
...
* [aidankinzett.com](https://aidankinzett.com) ([Source](https://github.com/aidankinzett/astro-blog) ⭐ 5 | 🐛 10 | 🌐 Astro | 📅 2026-09-02)
* [Tally](https://tally.johng.io) ([Source](https://github.com/twocaretcat/Tally) ⭐ 5 | 🐛 32 | 🌐 TypeScript | 📅 2026-09-06)
* [sadman.ca](https://sadman.ca/) ([Source](https://github.com/sadmanca/blogv2) ⚠️ Archived)
* [Goldplated Photos](https://goldplated.photos) - Self-hosted photo gallery with file-based storage, password protection, and PhotoSwipe lightbox ([Source](https://github.com/klukacin/goldplated-photos) ⭐ 0 | 🐛 0 | 🌐 Rust | 📅 2026-08-29)
