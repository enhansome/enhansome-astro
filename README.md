...
* [Astro Icon](https://github.com/natemoo-re/astro-icon) ⭐ 1,437 | 🐛 15 | 🌐 MDX | 📅 2026-08-25 - Straight-forward Icon component for Astro
* [Astro SEO](https://github.com/jonasmerlin/astro-seo) ⭐ 1,388 | 🐛 1 | 🌐 Astro | 📅 2026-08-28 - Better SEO with Astro
...
* [Astro Breadcrumbs](https://github.com/felix-berlin/astro-breadcrumbs) ⭐ 218 | 🐛 12 | 🌐 TypeScript | 📅 2026-08-28 - Well configurable breadcrumb component for Astro. Create breadcrumbs completely dynamically or specify exactly how they should look.
...
* [@unocss/astro](https://github.com/unocss/unocss/tree/main/packages/astro) ⭐ 18,943 | 🐛 135 | 🌐 TypeScript | 📅 2026-08-28 - The UnoCSS integration for Astro
* [Frontman](https://github.com/frontman-ai/frontman) ⭐ 680 | 🐛 244 | 🌐 ReScript | 📅 2026-08-28 - An open-source AI coding agent that lives in your browser, letting you click any element and describe changes in plain English to get real code edits with hot reload.
...
* [Astro Snapshot](https://github.com/twocaretcat/astro-snapshot) ⭐ 14 | 🐛 8 | 🌐 TypeScript | 📅 2026-07-19 - An Astro integration for generating screenshots of your pages automatically at build time
* [@aeorank/astro](https://github.com/vinpatel/aeorank) ⭐ 14 | 🐛 7 | 🌐 TypeScript | 📅 2026-08-27 - AEO (Answer Engine Optimization) integration for Astro — generates llms.txt, schema.json, and more AI-readable files
...
* [Taiwan.md](https://taiwan.md) - Open-source, AI-friendly knowledge base about Taiwan. 400+ Markdown articles, bilingual, knowledge graph, and public API. ([GitHub](https://github.com/frank890417/taiwan-md) ⭐ 1,158 | 🐛 18 | 🌐 HTML | 📅 2026-08-28 — 600+ ⭐)
* [Watchboard](https://artemiop.com/watchboard/) - AI-powered intelligence dashboard platform with 48 trackers, CesiumJS 3D globe, Leaflet maps, and nightly automated data updates ([Source](https://github.com/ArtemioPadilla/watchboard) ⭐ 19 | 🐛 11 | 🌐 TypeScript | 📅 2026-08-28)
...
* [aidankinzett.com](https://aidankinzett.com) ([Source](https://github.com/aidankinzett/astro-blog) ⭐ 5 | 🐛 10 | 🌐 Astro | 📅 2026-08-27)
