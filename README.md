...
* [Astro Theme - AstroWind](https://github.com/onwidget/astrowind) ⭐ 5,957 | 🐛 2 | 🌐 Astro | 📅 2026-09-10 - Started template to make a website using Astro and Tailwind CSS.
...
* [AstroDeck](https://github.com/holger1411/astrodeck) ⭐ 75 | 🐛 0 | 🌐 Astro | 📅 2026-09-05 - Production-ready Astro 6 starter with Tailwind CSS 4, shadcn/ui, dark mode, 11 page templates and 5 AI agents (AGENTS.md)
...
* [Astro Icon](https://github.com/natemoo-re/astro-icon) ⭐ 1,439 | 🐛 16 | 🌐 MDX | 📅 2026-08-25 - Straight-forward Icon component for Astro
...
* [Astro Breadcrumbs](https://github.com/felix-berlin/astro-breadcrumbs) ⭐ 220 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-11 - Well configurable breadcrumb component for Astro. Create breadcrumbs completely dynamically or specify exactly how they should look.
...
* [@unocss/astro](https://github.com/unocss/unocss/tree/main/packages/astro) ⭐ 18,953 | 🐛 140 | 🌐 TypeScript | 📅 2026-09-11 - The UnoCSS integration for Astro
* [Frontman](https://github.com/frontman-ai/frontman) ⭐ 692 | 🐛 236 | 🌐 ReScript | 📅 2026-09-11 - An open-source AI coding agent that lives in your browser, letting you click any element and describe changes in plain English to get real code edits with hot reload.
...
* [@aeorank/astro](https://github.com/vinpatel/aeorank) ⭐ 14 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-10 - AEO (Answer Engine Optimization) integration for Astro — generates llms.txt, schema.json, and more AI-readable files
...
* [Taiwan.md](https://taiwan.md) - Open-source, AI-friendly knowledge base about Taiwan. 400+ Markdown articles, bilingual, knowledge graph, and public API. ([GitHub](https://github.com/frank890417/taiwan-md) ⭐ 1,170 | 🐛 4 | 🌐 HTML | 📅 2026-09-11 — 600+ ⭐)
* [Watchboard](https://artemiop.com/watchboard/) - AI-powered intelligence dashboard platform with 48 trackers, CesiumJS 3D globe, Leaflet maps, and nightly automated data updates ([Source](https://github.com/ArtemioPadilla/watchboard) ⭐ 19 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-11)
...
* [aidankinzett.com](https://aidankinzett.com) ([Source](https://github.com/aidankinzett/astro-blog) ⭐ 5 | 🐛 10 | 🌐 Astro | 📅 2026-09-10)
