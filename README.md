...
* [Astro Theme - AstroWind](https://github.com/onwidget/astrowind) ⭐ 5,940 | 🐛 2 | 🌐 Astro | 📅 2026-09-07 - Started template to make a website using Astro and Tailwind CSS.
...
* [Starwind UI](https://github.com/starwind-ui/starwind-ui) ⭐ 724 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-06 - A set of powerful, accessible components for your Astro projects. Styled with Tailwind CSS v4.
...
* [Astro + Snipcart](https://github.com/lloydjatkinson/astro-snipcart) ⭐ 124 | 🐛 4 | 🌐 Astro | 📅 2025-09-17
...
* [Astro Icon](https://github.com/natemoo-re/astro-icon) ⭐ 1,440 | 🐛 16 | 🌐 MDX | 📅 2026-08-25 - Straight-forward Icon component for Astro
* [Astro SEO](https://github.com/jonasmerlin/astro-seo) ⭐ 1,395 | 🐛 1 | 🌐 Astro | 📅 2026-08-28 - Better SEO with Astro
...
* [Astro Breadcrumbs](https://github.com/felix-berlin/astro-breadcrumbs) ⭐ 219 | 🐛 13 | 🌐 TypeScript | 📅 2026-09-07 - Well configurable breadcrumb component for Astro. Create breadcrumbs completely dynamically or specify exactly how they should look.
...
* [@unocss/astro](https://github.com/unocss/unocss/tree/main/packages/astro) ⭐ 18,949 | 🐛 137 | 🌐 TypeScript | 📅 2026-09-08 - The UnoCSS integration for Astro
* [Frontman](https://github.com/frontman-ai/frontman) ⭐ 690 | 🐛 242 | 🌐 ReScript | 📅 2026-09-08 - An open-source AI coding agent that lives in your browser, letting you click any element and describe changes in plain English to get real code edits with hot reload.
...
* [@yeskunall/umami](https://github.com/yeskunall/astro-umami) ⭐ 72 | 🐛 12 | 🌐 TypeScript | 📅 2026-09-07 - Add Umami Analytics to your website
...
* [@aeorank/astro](https://github.com/vinpatel/aeorank) ⭐ 14 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-07 - AEO (Answer Engine Optimization) integration for Astro — generates llms.txt, schema.json, and more AI-readable files
...
* [Taiwan.md](https://taiwan.md) - Open-source, AI-friendly knowledge base about Taiwan. 400+ Markdown articles, bilingual, knowledge graph, and public API. ([GitHub](https://github.com/frank890417/taiwan-md) ⭐ 1,169 | 🐛 5 | 🌐 HTML | 📅 2026-09-08 — 600+ ⭐)
* [Watchboard](https://artemiop.com/watchboard/) - AI-powered intelligence dashboard platform with 48 trackers, CesiumJS 3D globe, Leaflet maps, and nightly automated data updates ([Source](https://github.com/ArtemioPadilla/watchboard) ⭐ 19 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-08)
...
* [aidankinzett.com](https://aidankinzett.com) ([Source](https://github.com/aidankinzett/astro-blog) ⭐ 5 | 🐛 10 | 🌐 Astro | 📅 2026-09-07)
