...
* [Astro Theme - AstroWind](https://github.com/onwidget/astrowind) ⭐ 5,895 | 🐛 23 | 🌐 Astro | 📅 2026-08-08 - Started template to make a website using Astro and Tailwind CSS.
* [Astro Theme - Cactus](https://github.com/chrismwilliams/astro-theme-cactus) ⭐ 1,713 | 🐛 7 | 🌐 Astro | 📅 2026-07-25 - Simple, opinionated starter built with the Astro framework for blog or website
...
* [Starwind UI](https://github.com/starwind-ui/starwind-ui) ⭐ 705 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-21 - A set of powerful, accessible components for your Astro projects. Styled with Tailwind CSS v4.
* [Astro Ink](https://github.com/one-aalam/astro-ink) ⭐ 599 | 🐛 9 | 🌐 Astro | 📅 2025-11-03 - Crisp, minimal, personal blog theme for Astro
...
* [Astro Icon](https://github.com/natemoo-re/astro-icon) ⭐ 1,432 | 🐛 21 | 🌐 MDX | 📅 2026-08-20 - Straight-forward Icon component for Astro
* [Astro SEO](https://github.com/jonasmerlin/astro-seo) ⭐ 1,384 | 🐛 7 | 🌐 Astro | 📅 2026-01-14 - Better SEO with Astro
...
* [Astro Breadcrumbs](https://github.com/felix-berlin/astro-breadcrumbs) ⭐ 219 | 🐛 11 | 🌐 TypeScript | 📅 2026-08-21 - Well configurable breadcrumb component for Astro. Create breadcrumbs completely dynamically or specify exactly how they should look.
...
* [Astro Auto-import](https://github.com/delucis/astro-auto-import) ⭐ 157 | 🐛 9 | 🌐 TypeScript | 📅 2026-08-19 - Auto-import components in Astro projects
...
* [@unocss/astro](https://github.com/unocss/unocss/tree/main/packages/astro) ⭐ 18,929 | 🐛 152 | 🌐 TypeScript | 📅 2026-08-20 - The UnoCSS integration for Astro
* [Frontman](https://github.com/frontman-ai/frontman) ⭐ 668 | 🐛 236 | 🌐 ReScript | 📅 2026-08-20 - An open-source AI coding agent that lives in your browser, letting you click any element and describe changes in plain English to get real code edits with hot reload.
...
* [@yeskunall/umami](https://github.com/yeskunall/astro-umami) ⭐ 71 | 🐛 11 | 🌐 TypeScript | 📅 2026-08-18 - Add Umami Analytics to your website
...
* [@aeorank/astro](https://github.com/vinpatel/aeorank) ⭐ 14 | 🐛 7 | 🌐 TypeScript | 📅 2026-08-20 - AEO (Answer Engine Optimization) integration for Astro — generates llms.txt, schema.json, and more AI-readable files
...
* [Taiwan.md](https://taiwan.md) - Open-source, AI-friendly knowledge base about Taiwan. 400+ Markdown articles, bilingual, knowledge graph, and public API. ([GitHub](https://github.com/frank890417/taiwan-md) ⭐ 1,154 | 🐛 60 | 🌐 HTML | 📅 2026-08-20 — 600+ ⭐)
* [Watchboard](https://artemiop.com/watchboard/) - AI-powered intelligence dashboard platform with 48 trackers, CesiumJS 3D globe, Leaflet maps, and nightly automated data updates ([Source](https://github.com/ArtemioPadilla/watchboard) ⭐ 19 | 🐛 7 | 🌐 TypeScript | 📅 2026-08-21)
...
* [Goldplated Photos](https://goldplated.photos) - Self-hosted photo gallery with file-based storage, password protection, and PhotoSwipe lightbox ([Source](https://github.com/klukacin/goldplated-photos) ⭐ 0 | 🐛 0 | 🌐 Astro | 📅 2026-08-20)
